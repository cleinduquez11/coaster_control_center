...
class SandBoxVisualization extends StatefulWidget {
    final List<String> overlayImages;
        final int length;
        final String url;

  const SandBoxVisualization({super.key, required this.overlayImages, required this.length, required this.url});
  @override
  State<SandBoxVisualization> createState() => SandBoxVisualizationState();
}

class SandBoxVisualizationState extends State<SandBoxVisualization> {
  late Timer _timer;
  int _currentIndex = 0;
  ...
  oI  = List.generate(widget.length, (index) => '${widget.url}\\output\\swan\\raw\\${index + 1}.png');
