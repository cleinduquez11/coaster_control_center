...
void reset() {
  ...
  void plot(path) async {
    ...
    notifyListeners();
           await File('$curDir${sndPath}input\\wind_estimation\\swan\\checker1.txt').writeAsString(' ');
   await Process.start(
        'cmd',
        [
          '/c',
          'python',
          '$curDir${sndPath}input\\wind_estimation\\swan\\wave.py'
        ],
    ...
    Timer.periodic(const Duration(seconds: 1), (timer) async {
      String curDir = Directory.current.path;
      String filePath = '$curDir${sndPath}input\\wind_estimation\\swan\\checker1.txt';
